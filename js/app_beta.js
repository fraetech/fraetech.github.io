...
async function loadCsvAndInit(dataStore, mapManager) {
  try {
    ...
    const base = csvPath ? csvPath : 'hebdo/beta';
    const csvUrl = `https://github.com/fraetech/fraetech.github.io/releases/download/latest/beta.csv`;
    const timestampUrl = `https://github.com/fraetech/fraetech.github.io/releases/download/latest/timestamp.txt`;
